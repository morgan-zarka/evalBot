...
SwitchersInit
	; ;; Enable the Port D peripheral clock 		(p291 datasheet de lm3s9B96.pdf)									
		...
		ldr r0, [r6]                            
        orr r0, r0, #0x08 					    ;; Enable clock sur GPIO D o� sont branch�s les switchers sans d�truire la conf des autres ports des autres
...
ReadSwitch1
		ldr r0, [r7] ;; R�sultat stock� dans le registre de retour r0
		BX LR

ReadSwitch2
		ldr r0, [r8] ;; R�sultat stock� dans le registre de retour r0
		BX LR
